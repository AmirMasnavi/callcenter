...
export default function Login({onLogin}:{onLogin:(m:Me)=>void}){
 ...
 return <main className="login-page"><section className="login-art"><img src="/brand-logo.png" alt="لوگو" className="login-art-logo"/><p>علم و صنعت آریا</p><h1>هر تماس، یک قدم<br/>نزدیک‌تر به موفقیت</h1><span>گزارش‌های روزانه دقیق، تصمیم‌های سریع‌تر</span></section>
 <section className="login-panel"><form className="login-card" onSubmit={submit}><div className="mobile-brand"><img src="/brand-logo.png" alt="لوگو" className="brand-logo"/><b>گزارش‌یار آریا</b></div><small>خوش آمدید</small><h2>ورود به سامانه</h2><p>برای ادامه، اطلاعات حساب سازمانی خود را وارد کنید.</p>
