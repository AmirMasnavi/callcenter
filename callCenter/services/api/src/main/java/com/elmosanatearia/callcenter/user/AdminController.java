...
public class AdminController {
 ...
 public record UserView(Long id,String username,String displayName,Role role,Long supervisorId,String supervisorName,boolean active,boolean mustChangePassword){
  static UserView of(AppUser u){return new UserView(u.getId(),u.getUsername(),u.getDisplayName(),u.getRole(),u.getSupervisor()==null?null:u.getSupervisor().getId(),u.getSupervisor()==null?null:u.getSupervisor().getDisplayName(),u.isActive(),u.isMustChangePassword());}}
